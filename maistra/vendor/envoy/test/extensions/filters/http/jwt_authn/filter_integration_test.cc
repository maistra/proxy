...
// BACKPORTING NOTE: The integration test framework doesn't support sending a
// request without a :path. Therefore we cannot test the issue at hand in this
// version.
TEST_P(LocalJwksIntegrationTest, DISABLED_ConnectRequestWithRegExMatch) {
