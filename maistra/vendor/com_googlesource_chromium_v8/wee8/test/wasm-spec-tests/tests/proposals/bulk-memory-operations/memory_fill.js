...
assert_return(() => call($7, "checkRange", [1, 65535, 170]), -1);

// memory_fill.wast:141
assert_return(() => call($7, "checkRange", [65535, 65536, 0]), -1);
...
assert_return(() => call($8, "checkRange", [28, 65536, 0]), -1);
...
assert_trap(() => call($9, "run", [65280, 37, 512]));

// memory_fill.wast:640
assert_return(() => call($9, "checkRange", [65280, 65536, 37]), -1);

// memory_fill.wast:642
assert_return(() => call($9, "checkRange", [0, 65280, 0]), -1);

// memory_fill.wast:644
let $10 = instance("");

// memory_fill.wast:661
assert_trap(() => call($10, "run", [65279, 37, 514]));
...
assert_trap(() => call($11, "run", [65279, 37, -1]));

// memory_fill.wast:688
assert_return(() => call($11, "checkRange", [65279, 65536, 37]), -1);

// memory_fill.wast:690
assert_return(() => call($11, "checkRange", [0, 65279, 0]), -1);
