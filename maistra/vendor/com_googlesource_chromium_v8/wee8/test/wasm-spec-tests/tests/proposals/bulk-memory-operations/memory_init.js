...
assert_trap(() => call($17, "run", [65528, 16]));

// memory_init.wast:828
assert_return(() => call($17, "checkRange", [0, 65528, 0]), -1);

// memory_init.wast:830
assert_return(() => call($17, "checkRange", [65528, 65536, 66]), -1);

// memory_init.wast:832
assert_return(() => call($17, "checkRange", [65536, 65536, 0]), -1);

// memory_init.wast:834
let $18 = instance("");

// memory_init.wast:852
assert_trap(() => call($18, "run", [65527, 16]));

// memory_init.wast:855
assert_return(() => call($18, "checkRange", [0, 65527, 0]), -1);

// memory_init.wast:857
assert_return(() => call($18, "checkRange", [65527, 65536, 66]), -1);
...
assert_trap(() => call($19, "run", [65472, 30]));

// memory_init.wast:882
assert_return(() => call($19, "checkRange", [0, 65472, 0]), -1);

// memory_init.wast:884
assert_return(() => call($19, "checkRange", [65472, 65488, 66]), -1);

// memory_init.wast:886
assert_return(() => call($19, "checkRange", [65488, 65536, 0]), -1);

// memory_init.wast:888
let $20 = instance("");

// memory_init.wast:906
assert_trap(() => call($20, "run", [65473, 31]));

// memory_init.wast:909
assert_return(() => call($20, "checkRange", [0, 65473, 0]), -1);

// memory_init.wast:911
assert_return(() => call($20, "checkRange", [65473, 65489, 66]), -1);

// memory_init.wast:913
assert_return(() => call($20, "checkRange", [65489, 65536, 0]), -1);
...
assert_trap(() => call($21, "run", [65528, -256]));

// memory_init.wast:936
assert_return(() => call($21, "checkRange", [0, 65528, 0]), -1);

// memory_init.wast:938
assert_return(() => call($21, "checkRange", [65528, 65536, 66]), -1);

// memory_init.wast:940
assert_return(() => call($21, "checkRange", [65536, 65536, 0]), -1);
...
assert_return(() => call($22, "checkRange", [16, 65536, 0]), -1);
