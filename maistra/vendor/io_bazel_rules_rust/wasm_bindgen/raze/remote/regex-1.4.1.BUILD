...
rust_library(
    ...
    crate_type = "lib",
    deps = [
        "@rules_rust_wasm_bindgen__aho_corasick__0_7_14//:aho_corasick",
        "@rules_rust_wasm_bindgen__memchr__2_3_3//:memchr",
        "@rules_rust_wasm_bindgen__regex_syntax__0_6_20//:regex_syntax",
        "@rules_rust_wasm_bindgen__thread_local__1_0_1//:thread_local",
    ],
    srcs = glob(["**/*.rs"]),
