...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/powerpc64le-linux-gnu-gcc -shared -L/tools/deps/lib '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                "'--host=ppc64le-unknown-linux-gnu' '--prefix=/install' "
                ...
                "'host_alias=ppc64le-unknown-linux-gnu' "
                "'CC=/usr/bin/powerpc64le-linux-gnu-gcc' 'CFLAGS= -fPIC "
                '-I/tools/deps/include -I/tools/deps/include/ncursesw '
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311-powerpc64le-linux-gnu.so',
 'FILEMODE': 644,
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/powerpc64le-linux-gnu-gcc -shared -L/tools/deps/lib '
             '-Wl,--exclude-libs,ALL -L/tools/deps/libedit/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBPL': '/install/lib/python3.11/config-3.11-powerpc64le-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/usr/bin/powerpc64le-linux-gnu-gcc',
 ...
 'MAINCC': '/usr/bin/powerpc64le-linux-gnu-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHAREDMODS': 'Modules/_crypt.cpython-311-powerpc64le-linux-gnu.so',
 'SHELL': '/bin/sh',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-311-powerpc64le-linux-gnu',
