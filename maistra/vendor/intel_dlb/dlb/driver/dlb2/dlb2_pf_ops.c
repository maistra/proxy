...
static void
dlb2_mbox_cmd_register_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_unregister_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_get_num_resources_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_create_sched_domain_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_reset_sched_domain_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_create_ldb_queue_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_create_dir_queue_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_create_ldb_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_create_dir_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
	struct dlb2_mbox_create_ldb_port_cmd_resp resp;
...
static void
dlb2_mbox_cmd_enable_ldb_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_disable_ldb_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_enable_dir_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_disable_dir_port_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_unmap_qid_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_enable_ldb_port_intr_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_get_cos_bw_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_query_cq_poll_mode_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void
dlb2_mbox_cmd_dev_reset_fn(struct dlb2 *dlb2, int vf_id, void *data)
{
...
static void (*mbox_fn_table[])(struct dlb2 *dlb2, int vf_id, void *data) = {
...
void dlb2_handle_mbox_interrupt(struct dlb2 *dlb2, int id)
{
	...
	if (DLB2_MBOX_CMD_TYPE(data) >= NUM_DLB2_MBOX_CMD_TYPES) {
		...
		mbox_fn_table[DLB2_MBOX_CMD_TYPE(data)](dlb2, id, data);
	}
...
dlb2_compressed_cq_intr_handler(int irq, void *hdlr_ptr)
{
	...
	for (i = 0; i < DLB2_MAX_NUM_LDB_PORTS; i++) {
		...
		if (dlb2->ldb_port[i].efd_ctx)
			eventfd_signal(dlb2->ldb_port[i].efd_ctx, 1);
		else
	...
	for (i = 0; i < DLB2_MAX_NUM_DIR_PORTS(dlb2->hw_ver); i++) {
		...
		if (dlb2->dir_port[i].efd_ctx)
			eventfd_signal(dlb2->dir_port[i].efd_ctx, 1);
		else
...
dlb2_vf_attr_group_fail:
	for (i--; i >= 0; i--)
		devm_device_remove_group(dev, dlb2_vf_attrs[i]);

	devm_device_remove_groups(dev, dlb2_pf_attr_groups);
dlb2_pf_attr_groups_fail:
	return ret;
}
