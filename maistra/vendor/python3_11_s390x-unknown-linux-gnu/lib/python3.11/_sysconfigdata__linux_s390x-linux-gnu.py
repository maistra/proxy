...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/s390x-linux-gnu-gcc -shared -L/tools/deps/lib '
              '-Wl,--exclude-libs,ALL -L/tools/deps/libedit/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                "'--host=s390x-unknown-linux-gnu' '--prefix=/install' "
                ...
                "'host_alias=s390x-unknown-linux-gnu' "
                "'CC=/usr/bin/s390x-linux-gnu-gcc' 'CFLAGS= -fPIC "
                '-I/tools/deps/include -I/tools/deps/include/ncursesw '
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.4/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.4/lcov-report',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311-s390x-linux-gnu.so',
 'FILEMODE': 644,
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/s390x-linux-gnu-gcc -shared -L/tools/deps/lib '
             '-Wl,--exclude-libs,ALL -L/tools/deps/libedit/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -flto -fuse-linker-plugin '
 ...
 'LIBPL': '/install/lib/python3.11/config-3.11-s390x-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/usr/bin/s390x-linux-gnu-gcc',
 ...
 'MAINCC': '/usr/bin/s390x-linux-gnu-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.4 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.4/`cat pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_s390x-linux-gnu '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             '-fPIC -I/tools/deps/include '
                             '-I/tools/deps/include/ncursesw '
                             '-I/tools/deps/libedit/include -flto '
 ...
 'PY_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
              '-I/tools/deps/include -I/tools/deps/include/ncursesw '
              '-I/tools/deps/libedit/include',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                   '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                   '-I/tools/deps/libedit/include -flto -fuse-linker-plugin '
 ...
 'PY_CORE_LDFLAGS': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                    '-L/tools/deps/libedit/lib -flto -fuse-linker-plugin '
 ...
 'PY_LDFLAGS_NOLTO': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                     '-L/tools/deps/libedit/lib -fno-lto',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
 'PY_SQLITE_HAVE_SERIALIZE': 0,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                        '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                        '-I/tools/deps/libedit/include -flto '
                        '-fuse-linker-plugin -ffat-lto-objects '
                        '-flto-partition=none -g -std=c11 -Wextra '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.11.4',
 'SCRIPTDIR': '/install/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHAREDMODS': 'Modules/_crypt.cpython-311-s390x-linux-gnu.so',
 'SHELL': '/bin/sh',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-311-s390x-linux-gnu',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.11.4 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.4 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.4/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_s390x-linux-gnu '
               '/tools/pyhost/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.11.4 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.4 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.4/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.11.4',
 'abs_srcdir': '/build/Python-3.11.4',
